          ...
          <div className="flex flex-col lg:flex-row items-center gap-8">
            ...
            <div className="flex-1 text-center lg:text-left">
              <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 mb-4">
                <h2 className="text-4xl font-bold text-[#001844]">About Dr Md Khurshid Alam Hyder</h2>
              ...
              <div className="space-y-4 text-gray-800 leading-relaxed">
                <p className="text-lg">
                  <strong>Physician I Technical Assistance Consultant TB and Public Health Specialist I Global Health Expert</strong>
                </p>
                ...
                <p className="text-lg">
                  Connect: <a href="mailto:khurshidalamhyder@gmail.com" className="text-[#2D8CBB] font-bold underline hover:text-[#001844] transition-colors">khurshidalamhyder@gmail.com</a>
                </p>
              </div>
            </div>
          </div>
