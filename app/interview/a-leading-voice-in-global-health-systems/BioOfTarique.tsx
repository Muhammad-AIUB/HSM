            ...
            <div className="overflow-hidden relative max-w-screen-md mx-auto">
                <div className="py-6 font-medium">
                    <p className=" text-gray-700 mt-2 leading-relaxed text-justify">
                        Dr. Taufique Joarder is an Associate Professor and the
                        Lead of the Programme Evaluation Unit at the{" "}
                        <a
                        ...
                        With a doctorate in public health in health policy and
                        systems from the{" "}
                        <a
                        ...
                        , he has 16 years of experience in health policy and
                        systems research, implementation research and
                        evaluation. He has taught global health and research
                        methods and published extensively, with 46 peer-reviewed
                        articles and 10 books/chapters. His background includes
                        a consultancy position at the{" "}
                        <a
                        ...
                        , and significant policy and media engagement. He is
                        also an Editor of{" "}
                        <a
                        ...
                        His areas of expertise include health and nutrition
                        policy, human resources for health, implementation
                        science, program evaluation, and psychometrics. He also
                        serves as the Vice-Chairperson of the
                        <a
