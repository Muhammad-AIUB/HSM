      ...
      <div className="relative max-w-screen-md mx-auto">
        <div className="py-6 font-medium">
          <p className=" text-gray-700 mt-2 leading-relaxed text-justify">
            <strong>Dr. Barbara Gastel, Academician and Passionate Health Writer</strong> is a specialist in medical writing and editing, and a professor at Texas A&M University, where she directs the science journalism graduate program. She earned a BA from Yale and MD and MPH from Johns Hopkins. Before joining Texas A&M, she worked at the National Institutes of Health, MIT, Peking University Health Science Center, and the University of California, San Francisco.
          </p>
          <p className=" text-gray-700 mt-2 leading-relaxed text-justify">
            Dr. Gastel is lead author of the latest editions of How to Write and Publish a Scientific Paper, and her book Medical Editing: A Guide to Learning the Craft and Building Your Career will appear in late 2025. Long interested in international communication of science, she has given workshops in many countries in Asia, Africa, and the Americas.
          </p>
          <p className=" text-gray-700 mt-2 leading-relaxed text-justify">
