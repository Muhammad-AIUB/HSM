...
import SizearImage1 from "@/public/images/sizear/sizear1.jpg";

const AboutSizear = () => {
  return (
    <section className="relative w-full px-12 md:px-16 py-10 r overflow-hidden text-justify bg-white">
      {/* Background shapes */}
      ...
      <div className="relative max-w-6xl mx-auto flex flex-col md:flex-row gap-10 z-10 justify-between">
        {/* Left content */}
        <div className="w-full md:w-[80%] -mt-6 text-white">
          <div className="bg-[#001844] px-4 pb-4">
            <h1 className="text-[30px] md:text-[36px]  text-white">
              <span className="">Monaemul</span> <span className="">Islam</span>{" "}
              <span className="font-bold">Sizear</span>{" "}
              <span className="text-sm font-medium">(MSS, MPH, MSc)</span>
            </h1>

            {/* Titles */}
            <p className="mt-0 text-base">
              <span className="text-[#0f9ed5] font-semibold text-[17px]">
          ...
          <div className="mt-2 space-y-4 text-black">
            <p className="text-[17px] leading-[26px]">
              I am Monaemul Islam Sizear, widely known as{" "}
              <span className="font-bold">Sizear</span>. Public health is my
              profession, passion, and purpose by choice. My mission is to
            ...
            <p className="font-semibold text-[#0f9ed5] text-[17px]  leading-[26px] font-roboto">
        ...
        <div className="">
          <div className="flex justify-center">
            <Image
              ...
              width={250}
              height={200}
              className="rounded-xl w-full md:w-[85%] -mt-4"
            />
          </div>
