...
import BestOrganizerImg from "@/public/images/sizear/awards/Best-Organizer-Award.jpg";
...
const BestOrganizer = () => {
  return (
    <div className="py-16 bg-gradient-to-r from-cyan-50 via-white to-cyan-50 px-16 rounded-md shadow-sm">
        ...
        {organizerAwards.map((award, index) => (
          ...
          >
            {award.image ? (
              ...
              <div className="h-28 hidden md:block"></div>
            )}
            <div className="p-4">
