      ...
      >
        {educationData.map((item, index) => (
          <motion.div
            ...
            className={`bg-white border shadow-sm rounded-md p-6 border-l-4 border-blue-500 flex flex-col md:flex-row md:items-center md:space-x-6 group text-[#001844] ${
