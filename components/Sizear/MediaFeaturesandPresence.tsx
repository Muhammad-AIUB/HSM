...
const mediaFeatures = [
    ...
    //! Newly added videos 22 May, 2025
    {
        title: "স্বাস্থ্য সুরক্ষা ২০২৪: স্বপ্ন, সম্পৃক্ততা ও সম্ভাবনা | PHA সুরক্ষায় প্রতিদিন",
    ...
    },
    {
        ...
        platform: "YouTube",
        videoUrl:
            "https://www.youtube.com/embed/lHh4jjgvW3M?si=TCjO3ut1xAirlIid",
    },
];
...
const articles = [
    ...
    {
        title: "The City Seminar of the ITP on Sustainable Urban Water and Sanitation (SUWAS)",
        ...
        <div className="py-16 bg-gradient-to-r bg-[#E2E4F0] px-16 ">
            <div className="rounded-md shadow-sm mx-auto max-w-6xl">
                ...
                <p className="text-black text-[17px] text-justify">
                    I have an established media presence, particularly in
                    Bangladesh, where I address topics such as public health,
                    conferences, leadership, the debate movement, and career
                    development. I also facilitate events and sessions aimed at
                    supporting early-career professionals.
                </p>

                <p className="mt-2 mb-6 text-black text-[17px] text-justify">
                    Below are some key highlights showcasing my appearances
                    across various media outlets and platforms, with a focus on
                    my academic and professional expertise.
                </p>
