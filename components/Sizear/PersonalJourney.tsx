...
import sizearImage from "@/public/images/sizear/sizear2.jpg";
      ...
      <div className="flex flex-col md:flex-row gap-8 justify-between items-center">
        <div>
          <p className="text-black text-[17px] leading-relaxed text-justify pt-4">
            I was born into a typical Bangladeshi family, where high
            expectations shaped my childhood as an only child. Without strong
            guidance or role models in my broader family, I learned to dream and
            build a meaningful life on my own.
          </p>
          <p className="text-black text-[17px] leading-relaxed text-justify pt-4">
            My perspective shifted during my undergraduate years, largely
            influenced by books. Hillary Clinton's autobiography, particularly
            her statement, "Learn from the world what you cannot learn from your
            parents," inspired my journey of self-discovery and lifelong
            learning. Since then, I have drawn knowledge and inspiration from
            books, relationships, nature, personal experiences, and formal
            education.
          </p>
          <p className="text-black text-[17px] leading-relaxed text-justify pt-4">
            Academically, I earned three Master's degrees from international
            universities on scholarships. Yet, my most valuable lessons stem
            from practical experiences and observations. My transformation—from
            a guideless child to a public health professional—is also the story
            of becoming an organizer, builder, and writer.
          </p>
          <p className="text-black text-[17px] leading-relaxed text-justify pt-4">
            This journey has been filled with challenges and broken dreams, but
            my determination and resilience keep me moving forward. Two traits
            have defined my path. Patience during times of struggle, when I have
            little or nothing. Second, Attitude during times of abundance when
            life is generous.
          </p>
        </div>
        <div className="shrink-0 mt-4">
          <Image src={sizearImage} alt="Sizear" width={225} height={250} />
        </div>
      </div>

      <div className="space-y-8 max-w-3xl mx-auto p-6 mt-8 bg-green-300 rounded-lg shadow-sm">
