...
export default function ProfessionalTraining() {
  ...
  return (
    <div className=" bg-[#CDEDEC] py-16">
      <div className="max-w-screen-xl mx-auto px-12 lg:px-16">
        <h3 className="text-2xl md:text-2xl font-bold underline underline-offset-[6px] font-roboto text-[#0070c0] decoration-[#FFCE00]">
          Professional Development
        </h3>

        <h3 className="text-xl font-bold underline underline-offset-[6px] font-roboto text-[#113855] decoration-[#ef4444] py-8">
          Training
        </h3>
        ...
        >
          {trainings.map((item, index) => (
            <motion.div
              ...
              className={`flex items-start space-x-4 bg-white shadow-sm rounded-md p-4 border-l-4 border-blue-500 group transition-all duration-300 ${
