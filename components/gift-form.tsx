      ...
      <DialogContent className="z-[50000] max-w-[650px] min-h-72 bg-cyan-100 px-8 flex items-center max-h-screen overflow-auto p-0">
        ...
        <div className="h-full p-8 rounded-md font-roboto text-justify text-lg">
          <div className="flex flex-col items-center justify-center py-8 text-center space-y-4">
            ...
            <h3 className="text-xl font-semibold font-[#2D8CBB]">
              Thank You, {name}!
            </h3>
            <p className="text-black">
              Please check your email—the gift has been sent as an attachment.
          ...
          <div className="flex justify-center items-center">
            <a
              ...
              className="ml-6 w-40 block px-4 py-2 bg-[#001844] rounded-md text-white text-center text-base"
            >
              Download Gift
            </a>
          </div>
