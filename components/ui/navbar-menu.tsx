  ...
  return (
    ...
    >
      <motion.p
        ...
        className={`cursor-pointer text-sm font-bold ${className} hover:opacity-[0.9] dark:text-white text-center`}
      >
        {item}
      </motion.p>
      {active !== null && (
...
export const Menu = ({
  ...
  return (
    <nav
      ...
      className={cn(
        "relative text-white dark:bg-black dark:border-white/[0.2] flex justify-center items-center space-x-8 px-8 py-3 ",
        className
      )}
    >
      {children}
...
export const HoveredLink = ({ children, active, ...rest }: any) => {
  ...
  return (
    <Link
      {...rest}
      className={cn(
        "text-white font-semibold hover:text-slate-200 flex items-center gap-1 z-[500]",
        active && ""
      )}
